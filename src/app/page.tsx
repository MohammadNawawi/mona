...
export default function Home() {
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="w-screen h-screen dark:bg-neutral-950 ">
        ...
        <div className="mx-auto max-w-6xl gap-4 px-6 transition-all duration-200 ease-in-out lg:px-12 justify-between grid lg:grid-cols-12 py-10">
          <div className="col-span-9">
            <article className="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              <h1 className="font-bold">Chilly</h1>
              <p className="line-clamp-2 text-sm">
                Amid the ever-evolving landscape, a solitary figure stands,
                draped in a voluminous warm coat that whispers tales of journeys
                taken.
              </p>
            </article>
            <div className="grid lg:grid-cols-9 mt-3 gap-3">
              <article className="block col-span-3 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              ...
              <article className="block col-span-3 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <p className="line-clamp-2 text-sm">
                  A figure sits in stillness, their demeanor suggesting a trance
                  or stand-by mode.
                </p>
              </article>
              <article className="block col-span-3 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              ...
              <article className="block col-span-3 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <p className="line-clamp-2 text-sm">
                  In a world where technology enhances human potential, a figure
                  soars, suspended in mid-air.
                </p>
              </article>
              <article className="block col-span-3 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              ...
              <article className="block col-span-3 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <p className="line-clamp-2 text-sm">
                  ...
                  stands out, draped in a warm coat bearing the emblematic "New
                  Decree" logo—an ambiguous happy face.
                </p>
              </article>
              <article className="block col-span-3 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <h1 className="font-bold">Growth</h1>
                <p className="line-clamp-2 text-sm">
                  In a world of advanced cognition, a woman immerses herself in
                  literature, her eyes aided by a cutting-edge learning and
                  vision device.
                </p>
              </article>
              <article className="block col-span-3 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <p className="line-clamp-2 text-sm">
                  Amidst a futuristic landscape, a transhuman ambles with an air
                  of nonchalance.
                </p>
              </article>
            </div>
          ...
          <a
            ...
            className="col-span-3 bg-white hover:bg-gray-100 rounded-lg shadow-lg border p-6 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
          >
            <div>
              <p>Add here</p>
            </div>
